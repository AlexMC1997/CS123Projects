...
//   CS123SceneMaterial() {}
   ...
   glm::vec3 ior; // index of refraction
   glm::vec3 abs; // absorption coefficient
   ...
   void clear() {
       ...
       cSpecular.r = cSpecular.g = cSpecular.b = cSpecular.a = 1.0f;
       ...
       transparency = 0.0f;
       glossiness = 0.0f;
       ior.r = ior.g = ior.b = 1.6; //plastic-like
   }
};
