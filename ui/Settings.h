...
//Enumeration values for lighting model
enum LightingType {
    LIGHTING_CONSTANT,
    LIGHTING_LAMBERTIAN,
    LIGHTING_PHONG
...
struct Settings {
    ...
    float materialParameter1; //R
    float materialParameter2; //G
    float materialParameter3; //B
    float materialParameter4; //Glossiness
    float materialParameter5; //Roughness
    float materialParameter6; //Metalness
    float materialParameter7; //Transparency
    float materialParameter8; //IOR R
    float materialParameter9; //IOR G
    float materialParameter10; //IOR B
    float materialParameter11; //Abs. R
    float materialParameter12; //Abs. G
    float materialParameter13; //Abs. B
