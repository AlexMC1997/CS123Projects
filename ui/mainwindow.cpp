...
#define BIND(b) { \
    ...
    QButtonGroup *lightingButtonGroup = new QButtonGroup;
    QButtonGroup *shadingButtonGroup = new QButtonGroup;
    QButtonGroup *domainButtonGroup = new QButtonGroup;
    ...
    m_buttonGroups.push_back(lightingButtonGroup);
    m_buttonGroups.push_back(shadingButtonGroup);
    m_buttonGroups.push_back(domainButtonGroup);
    ...
    BIND(ChoiceBinding::bindRadioButtons(
             ...
             ui->spatialDomainButton,
             ui->intensityDomainButton,
             ui->frequencyDomainButton))
    BIND(ChoiceBinding::bindRadioButtons(
            filterButtonGroup,
            NUM_FILTER_TYPES,
            settings.filterType,
    ...
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider1, ui->materialParameterTextbox1, settings.materialParameter1, 0.f, 1.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider2, ui->materialParameterTextbox2, settings.materialParameter2, 0.f, 1.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider3, ui->materialParameterTextbox3, settings.materialParameter3, 0.f, 1.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider4, ui->materialParameterTextbox4, settings.materialParameter4, 0.f, 1.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider5, ui->materialParameterTextbox5, settings.materialParameter5, 0.f, 1.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider6, ui->materialParameterTextbox6, settings.materialParameter6, 0.f, 1.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider7, ui->materialParameterTextbox7, settings.materialParameter7, 0.f, 1.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider8, ui->materialParameterTextbox8, settings.materialParameter8, 0.f, 10.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider9, ui->materialParameterTextbox9, settings.materialParameter9, 0.f, 10.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider10, ui->materialParameterTextbox10, settings.materialParameter10, 0.f, 10.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider11, ui->materialParameterTextbox11, settings.materialParameter11, 0.f, 10.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider12, ui->materialParameterTextbox12, settings.materialParameter12, 0.f, 10.f))
    BIND(FloatBinding::bindSliderAndTextbox(
             ui->materialParameterSlider13, ui->materialParameterTextbox13, settings.materialParameter13, 0.f, 10.f))
    ...
    BIND(ChoiceBinding::bindRadioButtons(
             lightingButtonGroup,
             4,
             settings.lightingType,
             ui->lightingTypeConstant,
             ui->lightingTypeLambertian,
             ui->lightingTypePhong,
             ui->lightingTypeCT))
    BIND(ChoiceBinding::bindRadioButtons(
             shadingButtonGroup,
             3,
             settings.shadingType,
             ui->shadingTypeTriangle,
             ui->shadingTypeVertex,
             ui->shadingTypePixel))
    ...
    BIND(FloatBinding::bindSliderAndTextbox(
              ui->cameraFarSlider, ui->cameraFarTextbox, settings.cameraFar, 0.1, 300))
...
//                }
            ...
            m_canvas3D->loadMeshToShapesScene(file);
        } else {
...
void MainWindow::subdivideMesh() {
    ...
    // Subdivide the mesh.
    m_canvas3D->subdivideShapesMesh();
...
void MainWindow::resetSliders() {
    ...
    ui->cameraFarTextbox->setText(QString::number(300, 'f', 1));
