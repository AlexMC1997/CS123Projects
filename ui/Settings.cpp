...
void Settings::loadSettingsOrDefaults() {
    ...
    // Filter
    filterType = s.value("imageDomain", IMAGE_SPATIAL).toInt();
    ...
    materialParameter1 = s.value("materialParameter1", 1.0).toFloat();
    materialParameter2 = s.value("materialParameter2", 0.3).toFloat();
    materialParameter3 = s.value("materialParameter3", 0).toFloat();
    materialParameter4 = s.value("materialParameter4", 0).toFloat();
    materialParameter5 = s.value("materialParameter5", 0).toFloat();
    materialParameter6 = s.value("materialParameter6", 0).toFloat();
    materialParameter7 = s.value("materialParameter7", 0).toFloat();
    materialParameter8 = s.value("materialParameter8", 1).toFloat();
    materialParameter9 = s.value("materialParameter9", 1).toFloat();
    materialParameter10 = s.value("materialParameter10", 1).toFloat();
    materialParameter11 = s.value("materialParameter11", 0).toFloat();
    materialParameter12 = s.value("materialParameter12", 0).toFloat();
    materialParameter13 = s.value("materialParameter13", 0).toFloat();
    lightingType = s.value("lightingType", 0).toInt();
    shadingType = s.value("shadingType", 0).toInt();
    ...
    cameraFar = s.value("cameraFar", 300).toDouble();
